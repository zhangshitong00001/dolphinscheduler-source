...
@PrepareForTest({DorisDataSourceClient.class, DorisDataSourceChannel.class})
public class DorisDataSourceChannelTest {

    @Test
    public void testCreateDataSourceClient() {
        DorisDataSourceChannel sourceChannel = PowerMockito.mock(DorisDataSourceChannel.class);
        DorisDataSourceClient dataSourceClient = PowerMockito.mock(DorisDataSourceClient.class);
        PowerMockito.when(sourceChannel.createDataSourceClient(Mockito.any(), Mockito.any()))
                .thenReturn(dataSourceClient);
        Assert.assertNotNull(sourceChannel.createDataSourceClient(new DorisConnectionParam(), DbType.DORIS));
    }
}
